...
Route::middleware(['auth:web', 'admin'])->group(function () {
    ...
    Route::get('/admin/dashboard', [DashboardInsightsController::class, 'index'])->name('admin.dashboard');   ///home
  ...
  //////////////////////////////////////  =======================
    ...
    Route::get('/admin/referral-point-rules', [ReferralPointRuleController::class, 'index'])
        ->name('admin.referral-point-rules.index');

    Route::post('/admin/referral-point-rules', [ReferralPointRuleController::class, 'store'])
        ->name('admin.referral-point-rules.store');

    Route::delete('/admin/referral-point-rules/{rule}', [ReferralPointRuleController::class, 'destroy'])
        ->name('admin.referral-point-rules.destroy');

    Route::get('/kitchens/{kitchen}/rate', [AdminRateController::class, 'create'])
        ->name('admin.kitchens.rate');

    Route::post('/kitchens/{kitchen}/rate', [AdminRateController::class, 'rateKitchenAsClient'])
        ->name('admin.kitchens.rate.store');

    Route::get('/kitchens/{kitchen}/rates', [AdminRateController::class, 'kitchenRates'])
