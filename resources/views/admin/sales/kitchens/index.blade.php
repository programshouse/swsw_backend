...
<div class="kitchens-page" dir="rtl">
    ...
    <div class="page-header">
        ...
        <a
            href="{{ route('admin.sales.kitchens.create') }}"
            class="primary-btn"
        >
    ...
    <div class="content-card">
        ...
        <form
            method="GET"
            action="{{ route('admin.sales.kitchens.index') }}"
            class="filters"
        >
                ...
                <tbody>
                    @forelse ($kitchens as $kitchen)
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    class="status-badge status-{{ $kitchen->status }}"
                                >
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <form
                                        action="{{ route(
                                            'admin.sales.kitchens.toggle-status',
                                            $kitchen
                                        ) }}"
                                        method="POST"
                                    >
