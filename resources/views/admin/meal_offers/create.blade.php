...
<div class="page-title">إضافة عرض وجبة</div>

<div class="form-card">

    <form action="{{ route('admin.meal-offers.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <select name="kitchen_profile_id" class="form-input" required>
                ...
                @foreach($kitchens as $kitchen)
                    <option value="{{ $kitchen->id }}" {{ old('kitchen_profile_id') == $kitchen->id ? 'selected' : '' }}>
