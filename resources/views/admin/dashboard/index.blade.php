...
.dashboard-stat-card:hover .dashboard-stat-value{
    ...
    @php
      $sections = [
        ...
        'items' => [
            ...
            [
                'label' => 'أصحاب المطابخ',
                'value' => $data['users']['kitchens'],
                'icon' => '👨‍🍳',
                'url' => route('admin.kitchens.index'),
            ],
            [
                'label' => 'النشطين',
    ...
    [
        ...
        'items' => [
            [
                'label' => 'إجمالي المطابخ',
                'value' => $data['kitchens']['total'],
                'icon' => '🍽️',
                'url' => route('admin.kitchens.index'),
            ],
            [
                'label' => 'مطابخ مقبولة',
                'value' => $data['kitchens']['approved'],
                'icon' => '✅',
                'url' => route('admin.kitchens.index'),
            ],
            [
                'label' => 'قيد الانتظار',
                'value' => $data['kitchens']['pending'],
                'icon' => '⏳',
                'url' => route('admin.kitchens.index'),
            ],
            [
                'label' => 'مفتوحة الآن',
                'value' => $data['kitchens']['open_now'],
                'icon' => '🟢',
                'url' => route('admin.kitchens.index'),
            ],
        ],
    ...
    'items' => [
        ...
        [
            'label' => 'إجمالي الدليفري',
            'value' => $data['delivery']['total'],
            'icon' => '🚴',
            'url' => route('admin.delivery.approved'),
        ],
        ...
        [
            'label' => 'قيد الانتظار',
            'value' => $data['delivery']['pending'],
            'icon' => '⏳',
            'url' => route('admin.delivery.pending'),
        ],

        [
            'label' => 'دليفري مرفوض',
            'value' => $data['delivery']['rejected'],
            'icon' => '❌',
            'url' => route('admin.delivery.pending'),
        ],
    ...
    [
        ...
        'items' => [
            ...
            [
                'label' => 'وجبات مقبولة',
                'value' => $data['meals']['approved'],
                'icon' => '✅',
                'url' => route('admin.meals.index'),
            ],
            [
                'label' => 'قيد الانتظار',
                'value' => $data['meals']['pending'],
                'icon' => '⏳',
                'url' => route('admin.meals.index'),
            ],
            [
                'label' => 'المرفوضة الوجبات',
                'value' => $data['meals']['rejected'],
                'icon' => '🟢',
                'url' => route('admin.meals.index'),
            ],
        ],
    ...
    [
        ...
        'items' => [
            ...
            [
                ...
                'value' => $data['orders']['delivered_today'],
                'icon' => '🚚',
                'url' => route('admin.orders.index'),
            ],
            [
                'label' => 'إيرادات اليوم',
                'value' => number_format($data['orders']['today_revenue'], 2),
                'icon' => '💰',
                'url' => route('admin.orders.index'),
            ],
        ],
        ...
        <div class="dashboard-section">
            ...
            <div class="dashboard-stats-grid">
                @foreach ($section['items'] as $item)
                   <a href="{{ $item['url'] }}" class="dashboard-stat-card">
